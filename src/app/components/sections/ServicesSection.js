...
export default function ServicesSection() {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-5 lg:px-0 pt-16 lg:pt-[150px] grid grid-cols-7">
        ...
        <img
          src="/triangle.svg"
          alt="Triangle"
          className="absolute bottom-[-1px] left-0 w-[calc((100vw/7)+15px)] sm:w-[calc((100vw-640px)/2+748px/7)] md:w-[calc((100vw-768px)/2+870px/7)] lg:w-[calc((100vw-1024px)/2+1024px/7)] xl:w-[calc((100vw-1280px)/2+1280px/7)] 2xl:w-[calc((100vw-1536px)/2+1536px/7)]"
        />
      </div>
    </section>
  );

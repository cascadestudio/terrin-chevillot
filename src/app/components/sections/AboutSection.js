  ...
  return (
    <section className=" bg-white">
      <div className="container mx-auto px-5 lg:px-0 grid grid-cols-7 grid-rows-6 bg-grid-pattern bg-[length:calc((100%_-_40px)/7)_16.6667%] lg:bg-[length:14.2857%_16.6667%] bg-[left_1.25rem_top] lg:bg-left-top">
        <div className="relative col-span-3 row-start-2 row-span-3 -ml-5 sm:-ml-[calc((100vw-640px)/2)] md:-ml-[calc((100vw-768px)/2)] lg:-ml-[calc((100vw-1024px)/2)] xl:-ml-[calc((100vw-1280px)/2)] 2xl:-ml-[calc((100vw-1536px)/2)]">
          <img
            src="/about-image.jpg"
            alt="Chantier"
        ...
        <div className="col-span-4 row-span-2 row-start-3 py-7 px-10 bg-white border-t border-grey">

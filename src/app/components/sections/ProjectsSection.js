...
export default async function ProjectsSection() {
  ...
  return (
    <section className="bg-white text-blue">
      <div className="relative container mx-auto px-5 lg:px-0 grid grid-cols-7 grid-rows-10 bg-grid-pattern bg-[length:calc((100%_-_40px)/7)_16.6667%] lg:bg-[length:14.2857%_16.6667%] bg-[left_1.25rem_top] lg:bg-left-top">

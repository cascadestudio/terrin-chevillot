...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="relative pt-16 lg:pt-[150px] pb-2 bg-blue text-white"
    >
      <img
        src="/triangle.svg"
        alt="Triangle"
      ...
      <div className="container mx-auto px-5 lg:px-0 grid grid-cols-7">
        <div className="col-span-7 lg:col-start-2 lg:col-span-2 flex flex-col gap-5 lg:gap-11">
          ...
          <a
            href="https://www.google.fr/maps/place/99+Chem.+de+la+M%C3%BBre,+13015+Marseille/@43.3647287,5.3698352,863m/data=!3m2!1e3!4b1!4m6!3m5!1s0x12c9ea988606afc1:0xd452049b671da5e!8m2!3d43.3647248!4d5.3724101!16s%2Fg%2F11c17vpymg?entry=ttu&g_ep=EgoyMDI0MDkyNC4wIKXMDSoASAFQAw%3D%3D"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://www.facebook.com/terrin.chevillot"
            target="_blank"
            rel="noopener noreferrer"
          >
            Facebook
